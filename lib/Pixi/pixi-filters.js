 ...
 */
import { AlphaFilter as Ke, BlurFilterPass as H, Filter as c, Point as x, DEG_TO_RAD as F, utils as d, BLEND_MODES as qe, Texture as O, MIPMAP_MODES as U, SCALE_MODES as R, ObservablePoint as Z, Color } from "./pixi-legacy.min.js";
...
`; class Bt extends c { constructor(e = 16711680, r = 0, i = .4) { super(Vt, Nt), this._originalColor = 16711680, this._newColor = 0, this.uniforms.originalColor = new Float32Array(3), this.uniforms.newColor = new Float32Array(3), this.originalColor = e, this.newColor = r, this.epsilon = i } set originalColor(e) { const r = this.uniforms.originalColor; typeof e == "number" ? (r = new Color(e).toRgbArray(), this._originalColor = e) : (r[0] = e[0], r[1] = e[1], r[2] = e[2], this._originalColor = d.rgb2hex(r)) } get originalColor() { return this._originalColor } set newColor(e) { const r = this.uniforms.newColor; typeof e == "number" ? (r = new Color(e).toRgbArray(), this._newColor = e) : (r[0] = e[0], r[1] = e[1], r[2] = e[2], this._newColor = d.rgb2hex(r)) } get newColor() { return this._newColor } set epsilon(e) { this.uniforms.epsilon = e } get epsilon() { return this.uniforms.epsilon } } var Gt = `attribute vec2 aVertexPosition;
attribute vec2 aTextureCoord;
